...
var _meilab$elm_wexin_crypto$Types$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {board: a, status: b, dimension: c, holeCoord: d, distance: e, moves: f, directions: g};
	});
var _meilab$elm_wexin_crypto$Types$Down = {ctor: 'Down'};
var _meilab$elm_wexin_crypto$Types$Up = {ctor: 'Up'};
var _meilab$elm_wexin_crypto$Types$Right = {ctor: 'Right'};
var _meilab$elm_wexin_crypto$Types$Left = {ctor: 'Left'};
...
var _meilab$elm_wexin_crypto$Board$opposite = function (direction) {
	var _p0 = direction;
	switch (_p0.ctor) {
		case 'Left':
			return _meilab$elm_wexin_crypto$Types$Right;
		case 'Up':
			return _meilab$elm_wexin_crypto$Types$Down;
		case 'Right':
			return _meilab$elm_wexin_crypto$Types$Left;
		default:
			return _meilab$elm_wexin_crypto$Types$Up;
	}
};
var _meilab$elm_wexin_crypto$Board$possibleDirection = F2(
	function (_p2, _p1) {
		var _p3 = _p2;
		var _p6 = _p3._0;
		var _p4 = _p1;
...
var _meilab$elm_wexin_crypto$Board$moveTile = F4(
	function (tile, tileCoord, holeCoord, board) {
		return A2(
			...
			tileCoord,
			A3(_elm_lang$core$Dict$insert, holeCoord, tile, board));
	});
var _meilab$elm_wexin_crypto$Board$withinBoard = F2(
	function (dimension, _p7) {
		var _p8 = _p7;
		var _p10 = _p8._0;
		var _p9 = _p8._1;
		return ((_elm_lang$core$Native_Utils.cmp(_p10, 0) > 0) && ((_elm_lang$core$Native_Utils.cmp(_p10, dimension) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p9, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(_p9, dimension) < 1)))) ? true : false;
	});
var _meilab$elm_wexin_crypto$Board$shift = F2(
	function (_p11, direction) {
		var _p12 = _p11;
		var _p15 = _p12._0;
		var _p14 = _p12._1;
		var _p13 = direction;
		switch (_p13.ctor) {
			case 'Left':
				return {ctor: '_Tuple2', _0: _p15, _1: _p14 - 1};
			case 'Up':
				return {ctor: '_Tuple2', _0: _p15 - 1, _1: _p14};
			case 'Right':
				return {ctor: '_Tuple2', _0: _p15, _1: _p14 + 1};
			default:
				return {ctor: '_Tuple2', _0: _p15 + 1, _1: _p14};
...
var _meilab$elm_wexin_crypto$Board$isFinished = F2(
	function (board, dimension) {
		var bottomRightCoord = {ctor: '_Tuple2', _0: dimension, _1: dimension};
		var totalTiles = Math.pow(dimension, 2) - 1;
		return (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Dict$values(board),
			A2(_elm_lang$core$List$range, 1, totalTiles)) && _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Dict$get, bottomRightCoord, board),
			_elm_lang$core$Maybe$Nothing)) ? true : false;
	});
var _meilab$elm_wexin_crypto$Board$coords = function (dimension) {
	var coord = F2(
		function (row, column) {
			return {ctor: '_Tuple2', _0: row, _1: column};
		});
	var rowCoords = function (row) {
		return A2(
			_elm_lang$core$List$map,
			coord(row),
			A2(_elm_lang$core$List$range, 1, dimension));
	};
	return A2(
		_elm_lang$core$List$concatMap,
		rowCoords,
...
var _meilab$elm_wexin_crypto$Board$findHole = F2(
	function (dimension, board) {
		var go = F2(
			function (coord, acc) {
				return _elm_lang$core$Native_Utils.eq(
					A2(_elm_lang$core$Dict$get, coord, board),
					_elm_lang$core$Maybe$Nothing) ? coord : acc;
			});
		return A3(
			_elm_lang$core$List$foldr,
			go,
			{ctor: '_Tuple2', _0: 1, _1: 1},
			_meilab$elm_wexin_crypto$Board$coords(dimension));
	});
var _meilab$elm_wexin_crypto$Board$isSolvable = F2(
	function (board, dimension) {
		...
		var isOdd = function (_p16) {
			return !isEven(_p16);
		};
		var _p17 = A2(_meilab$elm_wexin_crypto$Board$findHole, dimension, board);
		var r = _p17._0;
		var holeRow = dimension - r;
		var countInversions = function (tiles) {
			var _p18 = tiles;
			if (_p18.ctor === '[]') {
				return 0;
			} else {
				var _p19 = _p18._1;
				var xInversions = _elm_lang$core$List$length(
					A2(
						_elm_lang$core$List$filter,
						function (y) {
							return _elm_lang$core$Native_Utils.cmp(_p18._0, y) > 0;
						},
						_p19));
				return xInversions + countInversions(_p19);
			}
		};
		var inversions = countInversions(
			_elm_lang$core$Dict$values(board));
		return isOdd(dimension) ? isEven(inversions) : ((isOdd(holeRow) && isOdd(inversions)) || (isEven(holeRow) && isEven(inversions)));
	});
var _meilab$elm_wexin_crypto$Board$slideTo = F3(
	function (dimension, direction, board) {
		var holeCoord = A2(_meilab$elm_wexin_crypto$Board$findHole, dimension, board);
		var tileCoord = A2(
			_meilab$elm_wexin_crypto$Board$shift,
			holeCoord,
			_meilab$elm_wexin_crypto$Board$opposite(direction));
		var possibleTile = A2(_elm_lang$core$Dict$get, tileCoord, board);
		var _p20 = possibleTile;
		if (_p20.ctor === 'Just') {
			return A4(_meilab$elm_wexin_crypto$Board$moveTile, _p20._0, tileCoord, holeCoord, board);
		} else {
			return board;
		}
	});
var _meilab$elm_wexin_crypto$Board$orderedTiles = function (dimension) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(
			_elm_lang$core$List$map,
...
var _meilab$elm_wexin_crypto$Board$makeBoard = F2(
	function (dimension, tiles) {
		var fillBoard = F2(
			function (_p21, board) {
				var _p22 = _p21;
				var _p23 = _p22._1;
				if (_p23.ctor === 'Nothing') {
					...
					return A3(_elm_lang$core$Dict$insert, _p22._0, _p23._0, board);
				}
			});
		return A3(
			_elm_lang$core$List$foldr,
...
var _meilab$elm_wexin_crypto$Board$randomBoard = function (dimension) {
	return A2(
		_elm_lang$core$Random$map,
		_meilab$elm_wexin_crypto$Board$makeBoard(dimension),
		_elm_community$random_extra$Random_List$shuffle(
			_meilab$elm_wexin_crypto$Board$orderedTiles(dimension)));
};
var _meilab$elm_wexin_crypto$Board$emptyBoard = _elm_lang$core$Dict$fromList(
	{ctor: '[]'});
var _meilab$elm_wexin_crypto$Board$allDirections = {
	ctor: '::',
	_0: _meilab$elm_wexin_crypto$Types$Left,
	_1: {
		ctor: '::',
		_0: _meilab$elm_wexin_crypto$Types$Up,
		_1: {
			ctor: '::',
			_0: _meilab$elm_wexin_crypto$Types$Right,
			_1: {
				ctor: '::',
				_0: _meilab$elm_wexin_crypto$Types$Down,
				_1: {ctor: '[]'}
			}
		}
	}
};
var _meilab$elm_wexin_crypto$Board$adjacentTo = F2(
	function (dimension, coord) {
		return A2(
			_elm_lang$core$List$filter,
			_meilab$elm_wexin_crypto$Board$withinBoard(dimension),
			A2(
				_elm_lang$core$List$map,
				_meilab$elm_wexin_crypto$Board$shift(coord),
				_meilab$elm_wexin_crypto$Board$allDirections));
	});
var _meilab$elm_wexin_crypto$Board$findAdjacentHole = F3(
	function (board, dimension, _p24) {
		var _p25 = _p24;
		var findHoleCoord = F2(
			function (coord, acc) {
				var _p26 = acc;
				if (_p26.ctor === 'Just') {
					return acc;
				} else {
					var _p27 = A2(_elm_lang$core$Dict$get, coord, board);
					if (_p27.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Just(coord);
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				}
		...
		return A3(
			...
			_elm_lang$core$Maybe$Nothing,
			A2(
				_meilab$elm_wexin_crypto$Board$adjacentTo,
				dimension,
...
var _meilab$elm_wexin_crypto$Messages$Recall = {ctor: 'Recall'};
var _meilab$elm_wexin_crypto$Messages$Replay = {ctor: 'Replay'};
var _meilab$elm_wexin_crypto$Messages$ChangeDimension = function (a) {
	return {ctor: 'ChangeDimension', _0: a};
};
var _meilab$elm_wexin_crypto$Messages$OtherKeyPressed = function (a) {
	return {ctor: 'OtherKeyPressed', _0: a};
};
var _meilab$elm_wexin_crypto$Messages$DirectionMove = F2(
	function (a, b) {
		return {ctor: 'DirectionMove', _0: a, _1: b};
	});
var _meilab$elm_wexin_crypto$Messages$TileClicked = F2(
	function (a, b) {
		return {ctor: 'TileClicked', _0: a, _1: b};
	});
var _meilab$elm_wexin_crypto$Messages$BoardGenerated = function (a) {
...
var _meilab$elm_wexin_crypto$Solver$manhattan = F3(
	function (_p0, tile, dimension) {
		var _p1 = _p0;
		var colDist = _elm_lang$core$Basics$abs(
			(_p1._1 - 1) - A2(_elm_lang$core$Basics_ops['%'], tile - 1, dimension));
		var rowDist = _elm_lang$core$Basics$abs((_p1._0 - 1) - (((tile - 1) / dimension) | 0));
		return _elm_lang$core$Native_Utils.eq(tile, 0) ? 0 : (rowDist + colDist);
	});
var _meilab$elm_wexin_crypto$Solver$boardDistance = F2(
	function (board, dimension) {
		var go = F2(
			function (coord, acc) {
				var tile = function () {
					var _p2 = A2(_elm_lang$core$Dict$get, coord, board);
					if (_p2.ctor === 'Nothing') {
						return 0;
					} else {
						return _p2._0;
				...
				var distance = A3(_meilab$elm_wexin_crypto$Solver$manhattan, coord, tile, dimension);
				return acc + distance;
			});
		return A3(
			_elm_lang$core$List$foldr,
...
var _meilab$elm_wexin_crypto$Solver$dfs = F7(
	function (board, dimension, depth, maxDepth, preDirection, holeCoord, directions) {
		var checkNeighbor = F2(
			function (direction, _p3) {
				var _p4 = _p3;
				var newHoleCoord = A2(_meilab$elm_wexin_crypto$Board$shift, holeCoord, direction);
				var newBoard = A3(_meilab$elm_wexin_crypto$Board$slideTo, dimension, direction, board);
				return A7(
					_meilab$elm_wexin_crypto$Solver$dfs,
					newBoard,
					dimension,
					depth + 1,
					maxDepth,
		...
		var possibleDirections = A2(
			_elm_lang$core$List$filter,
			function (direction) {
				return !_elm_lang$core$Native_Utils.eq(
					direction,
					_meilab$elm_wexin_crypto$Board$opposite(preDirection));
			},
			A2(
				_elm_lang$core$List$map,
				_meilab$elm_wexin_crypto$Board$possibleDirection(holeCoord),
				A2(_meilab$elm_wexin_crypto$Board$adjacentTo, dimension, holeCoord)));
		var h = A2(_meilab$elm_wexin_crypto$Solver$boardDistance, board, dimension);
		var f = depth + h;
		return (_elm_lang$core$Native_Utils.cmp(f, maxDepth) > 0) ? {
			ctor: '_Tuple2',
			_0: false,
			_1: {ctor: '[]'}
		} : (_elm_lang$core$Native_Utils.eq(h, 0) ? {ctor: '_Tuple2', _0: true, _1: directions} : A3(
			_elm_lang$core$List$foldl,
			checkNeighbor,
			{
				ctor: '_Tuple2',
...
var _meilab$elm_wexin_crypto$Solver$updateModel = F3(
	function (model, direction, category) {
		var newDirections = function () {
			...
			if (_p5.ctor === 'PushDirection') {
				...
				return A2(
					...
					{ctor: '[]'},
					_elm_lang$core$List$tail(model.directions));
			}
		}();
		var newHoleCoord = A2(
			_meilab$elm_wexin_crypto$Board$shift,
			...
			_meilab$elm_wexin_crypto$Board$opposite(direction));
		var tile = function () {
			var _p6 = A2(_elm_lang$core$Dict$get, newHoleCoord, model.board);
			if (_p6.ctor === 'Just') {
				return _p6._0;
			} else {
				return 0;
		...
		var newBoard = A3(_meilab$elm_wexin_crypto$Board$slideTo, model.dimension, direction, model.board);
		var newDistance = A2(_meilab$elm_wexin_crypto$Solver$boardDistance, newBoard, model.dimension);
		return _elm_lang$core$Native_Utils.eq(newBoard, model.board) ? model : _elm_lang$core$Native_Utils.update(
			model,
			{
				board: newBoard,
...
var _meilab$elm_wexin_crypto$Solver$makeMove = F2(
	function (model, direction) {
		var _p7 = A2(
			_meilab$elm_wexin_crypto$Board$withinBoard,
			model.dimension,
			A2(
				_meilab$elm_wexin_crypto$Board$shift,
				model.holeCoord,
		...
		if (_p7 === true) {
			return _elm_lang$core$Maybe$Just(
				A3(_meilab$elm_wexin_crypto$Solver$updateModel, model, direction, _meilab$elm_wexin_crypto$Types$PushDirection));
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _meilab$elm_wexin_crypto$Solver$generatePossibleStates = function (model) {
	return A2(
		_elm_lang$core$List$filterMap,
		_meilab$elm_wexin_crypto$Solver$makeMove(model),
		_meilab$elm_wexin_crypto$Board$allDirections);
};
var _meilab$elm_wexin_crypto$Solver$search = F3(
	function (depthLimit, visited, model) {
		var validStates = function (s) {
			return (!A2(
				_elm_lang$core$Set$member,
				_elm_lang$core$Dict$toList(s.board),
				visited)) && (_elm_lang$core$Native_Utils.cmp(s.distance + s.moves, depthLimit) < 1);
		};
		var possibleStates = A2(
			_elm_lang$core$List$filter,
			validStates,
			_meilab$elm_wexin_crypto$Solver$generatePossibleStates(model));
		var updatedVisited = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (possibleState, acc) {
					return A2(
						_elm_lang$core$Set$insert,
						_elm_lang$core$Dict$toList(possibleState.board),
						acc);
				}),
			visited,
			possibleStates);
		if (A2(_meilab$elm_wexin_crypto$Board$isFinished, model.board, model.dimension)) {
			return {
				ctor: '_Tuple3',
			...
			var _p8 = possibleStates;
			if (_p8.ctor === '[]') {
				return {ctor: '_Tuple3', _0: _elm_lang$core$Maybe$Nothing, _1: updatedVisited, _2: false};
			} else {
				return A3(
					_elm_lang$core$List$foldl,
					F2(
						function (possibleState, _p9) {
							var _p10 = _p9;
							var _p12 = _p10._0;
							var _p11 = A3(_meilab$elm_wexin_crypto$Solver$search, depthLimit, _p10._1, possibleState);
							var newResult = _p11._0;
							var newVisited = _p11._1;
							var isFound = _p11._2;
							return (_elm_lang$core$Native_Utils.eq(_p12, _elm_lang$core$Maybe$Nothing) && _elm_lang$core$Native_Utils.eq(newResult, _elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple3', _0: _elm_lang$core$Maybe$Nothing, _1: newVisited, _2: false} : ((!_elm_lang$core$Native_Utils.eq(newResult, _elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple3', _0: newResult, _1: newVisited, _2: true} : {ctor: '_Tuple3', _0: _p12, _1: newVisited, _2: true});
						}),
					{ctor: '_Tuple3', _0: _elm_lang$core$Maybe$Nothing, _1: updatedVisited, _2: false},
					possibleStates);
			}
		}
	});
var _meilab$elm_wexin_crypto$Solver$findSolution = F4(
	function (model, depthLimit, maxDepth, visited) {
		var newDepthLimit = depthLimit + 1;
		var solution = A3(_meilab$elm_wexin_crypto$Solver$search, depthLimit, visited, model);
		var _p13 = solution;
		if (_p13._0.ctor === 'Just') {
			...
			return A7(
				...
				_elm_lang$core$Debug$log,
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Set$size(_p14)),
				_elm_lang$core$Debug$log,
				_elm_lang$core$Basics$toString(_p14),
				_elm_lang$core$Task$succeed,
				_p13._0._0.directions);
		} else {
			return (_elm_lang$core$Native_Utils.cmp(newDepthLimit, maxDepth) < 1) ? A6(
				_elm_lang$core$Debug$log,
				_elm_lang$core$Basics$toString(newDepthLimit),
				_meilab$elm_wexin_crypto$Solver$findSolution,
				model,
				newDepthLimit,
				maxDepth,
				visited) : A3(_elm_lang$core$Debug$log, 'Not Found', _elm_lang$core$Task$fail, 'Solution Not Found');
		}
	});
var _meilab$elm_wexin_crypto$Solver$upperBound = 100;

var _meilab$elm_wexin_crypto$Utils$delay = F2(
	function (time, msg) {
		return A2(
			_elm_lang$core$Task$perform,
...
var _meilab$elm_wexin_crypto$Utils$cmd = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
...
var _meilab$elm_wexin_crypto$Update$init = function (dimension) {
	return {
		...
		_1: A2(
			...
			_meilab$elm_wexin_crypto$Board$randomBoard(dimension))
	};
};
var _meilab$elm_wexin_crypto$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'BoardGenerated':
				var _p1 = _p0._0;
				if (A2(_meilab$elm_wexin_crypto$Board$isSolvable, _p1, model.dimension) && (!A2(_meilab$elm_wexin_crypto$Board$isFinished, _p1, model.dimension))) {
					var distance = A2(_meilab$elm_wexin_crypto$Solver$boardDistance, _p1, model.dimension);
					var holeCoord = A2(_meilab$elm_wexin_crypto$Board$findHole, model.dimension, _p1);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{board: _p1, status: _meilab$elm_wexin_crypto$Types$Playing, holeCoord: holeCoord, distance: distance}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return _meilab$elm_wexin_crypto$Update$init(model.dimension);
				}
			case 'Replay':
				return _meilab$elm_wexin_crypto$Update$init(model.dimension);
			case 'ChangeDimension':
				return _meilab$elm_wexin_crypto$Update$init(
					A2(
			...
			case 'Recall':
				...
				if (_p5.ctor === 'Just') {
					return {
						...
						_0: model,
						_1: A2(
							_meilab$elm_wexin_crypto$Utils$delay,
			...
			case 'Resolve':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{status: _meilab$elm_wexin_crypto$Types$Solving}),
					_1: A2(
						_elm_lang$core$Task$attempt,
						_meilab$elm_wexin_crypto$Messages$SolutionFound,
						A4(
							_meilab$elm_wexin_crypto$Solver$findSolution,
							_elm_lang$core$Native_Utils.update(
								model,
							...
							A2(_meilab$elm_wexin_crypto$Solver$boardDistance, model.board, model.dimension),
							_meilab$elm_wexin_crypto$Solver$upperBound,
							_elm_lang$core$Set$singleton(
								_elm_lang$core$Dict$toList(model.board))))
				};
			case 'SolutionFound':
				if (_p0._0.ctor === 'Ok') {
					var _p6 = _p0._0._0;
					return A2(
						...
						_elm_lang$core$Basics$toString(_p6),
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{status: _meilab$elm_wexin_crypto$Types$ShowSolver, directions: _p6}),
...
var _meilab$elm_wexin_crypto$Styles$lineBreak = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'clear', _1: 'both'},
	_1: {ctor: '[]'}
};
var _meilab$elm_wexin_crypto$Styles$replayButton = {
	ctor: '::',
...
var _meilab$elm_wexin_crypto$Styles$victoryTitle = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'font-size', _1: '10vh'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin', _1: '0'},
		_1: {ctor: '[]'}
...
var _meilab$elm_wexin_crypto$Styles$victoryOverlay = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'z-index', _1: '999'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'rgba(255,255,255,0.95)'},
			_1: {
				ctor: '::',
...
var _meilab$elm_wexin_crypto$Styles$tile = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'float', _1: 'left'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'width', _1: '15vh'},
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'line-height', _1: '15vh'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'font-size', _1: '7vh'},
									_1: {
										ctor: '::',
...
var _meilab$elm_wexin_crypto$Styles$hole = A2(
	_elm_lang$core$List$append,
	_meilab$elm_wexin_crypto$Styles$tile,
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#CECECE'},
		_1: {
			ctor: '::',
...
var _meilab$elm_wexin_crypto$Styles$container = function (dimension) {
	return {
		ctor: '::',
		...
		_1: {
			...
			_0: {
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(dimension * 15),
					'vh')
			},
			_1: {
				ctor: '::',
...
var _meilab$elm_wexin_crypto$Views$renderFinishedScreen = function (status) {
	var _p0 = status;
	switch (_p0.ctor) {
		case 'Playing':
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_meilab$elm_wexin_crypto$Messages$Recall),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Recall'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('change dimension'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_meilab$elm_wexin_crypto$Messages$ChangeDimension),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _meilab$elm_wexin_crypto$Views$renderTile = F3(
...
var _meilab$elm_wexin_crypto$Views$renderRow = F3(
	function (board, dimension, row) {
		return A2(
			_elm_lang$core$List$append,
			A2(
				_elm_lang$core$List$map,
				A2(_meilab$elm_wexin_crypto$Views$renderTile, board, row),
				A2(_elm_lang$core$List$range, 1, dimension)),
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('line-break'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
...
var _meilab$elm_wexin_crypto$Views$renderBoard = F2(
	function (board, dimension) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(
				_elm_lang$core$List$concatMap,
				A2(_meilab$elm_wexin_crypto$Views$renderRow, board, dimension),
				A2(_elm_lang$core$List$range, 1, dimension)));
	});
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				_meilab$elm_wexin_crypto$Styles$container(model.dimension)),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			_meilab$elm_wexin_crypto$Views$renderFinishedScreen(model.status)));
};

var _meilab$elm_wexin_crypto$Main$subscriptions = function (model) {
	var arrowKeys = _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 37, _1: _meilab$elm_wexin_crypto$Types$Left},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 38, _1: _meilab$elm_wexin_crypto$Types$Up},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 39, _1: _meilab$elm_wexin_crypto$Types$Right},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 40, _1: _meilab$elm_wexin_crypto$Types$Down},
						_1: {ctor: '[]'}
					}
				}
			}
	...
	var keyPressed = function (code) {
		var _p0 = A2(_elm_lang$core$Dict$get, code, arrowKeys);
		if (_p0.ctor === 'Just') {
			return A2(_meilab$elm_wexin_crypto$Messages$DirectionMove, _p0._0, _meilab$elm_wexin_crypto$Types$PushDirection);
		} else {
...
var _meilab$elm_wexin_crypto$Main$main = _elm_lang$html$Html$program(
	{
		init: _meilab$elm_wexin_crypto$Update$init(3),
		update: _meilab$elm_wexin_crypto$Update$update,
		subscriptions: _meilab$elm_wexin_crypto$Main$subscriptions,
		view: _meilab$elm_wexin_crypto$Views$view
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _meilab$elm_wexin_crypto$Main$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"PlaySolverResult":[],"BoardGenerated":["Types.Board"],"Recall":[],"OtherKeyPressed":["Keyboard.KeyCode"],"Replay":[],"TileClicked":["Types.Tile","Types.Coord"],"ChangeDimension":["String"],"Resolve":[],"DirectionMove":["Types.Direction","Types.UpdateDirectionCategory"],"SolutionFound":["Result.Result String (List Types.Direction)"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Types.Direction":{"args":[],"tags":{"Down":[],"Up":[],"Left":[],"Right":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Types.UpdateDirectionCategory":{"args":[],"tags":{"PushDirection":[],"PopDirection":[]}}},"aliases":{"Types.Row":{"args":[],"type":"Int"},"Types.Board":{"args":[],"type":"Dict.Dict Types.Coord Types.Tile"},"Types.Column":{"args":[],"type":"Int"},"Keyboard.KeyCode":{"args":[],"type":"Int"},"Types.Coord":{"args":[],"type":"( Types.Row, Types.Column )"},"Types.Tile":{"args":[],"type":"Int"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
